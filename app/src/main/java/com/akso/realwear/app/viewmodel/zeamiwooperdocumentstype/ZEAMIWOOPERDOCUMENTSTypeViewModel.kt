package com.akso.realwear.app.viewmodel.zeamiwooperdocumentstype
...
/*
 * Represents View model for ZEAMIWOOPERDOCUMENTSType
 *
 ...
 */
class ZEAMIWOOPERDOCUMENTSTypeViewModel(application: Application): EntityViewModel<ZEAMIWOOPERDOCUMENTSType>(application, EntitySets.zeamIWoOperDocuments, ZEAMIWOOPERDOCUMENTSType.createdDate) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ZEAMIWOOPERDOCUMENTSType>(application, EntitySets.zeamIWoOperDocuments, ZEAMIWOOPERDOCUMENTSType.createdDate, navigationPropertyName, entityData)
    }
}
