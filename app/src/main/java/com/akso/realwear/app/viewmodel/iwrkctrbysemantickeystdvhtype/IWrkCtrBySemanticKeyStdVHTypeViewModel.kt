package com.akso.realwear.app.viewmodel.iwrkctrbysemantickeystdvhtype
...
/*
 * Represents View model for IWrkCtrBySemanticKeyStdVHType
 *
 ...
 */
class IWrkCtrBySemanticKeyStdVHTypeViewModel(application: Application): EntityViewModel<IWrkCtrBySemanticKeyStdVHType>(application, EntitySets.iWrkCtrBySemanticKeyStdVH, IWrkCtrBySemanticKeyStdVHType.workCenterText) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<IWrkCtrBySemanticKeyStdVHType>(application, EntitySets.iWrkCtrBySemanticKeyStdVH, IWrkCtrBySemanticKeyStdVHType.workCenterText, navigationPropertyName, entityData)
    }
}
