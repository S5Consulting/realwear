package com.akso.realwear.app.viewmodel.zeamiwooperaconfdettype
...
/*
 * Represents View model for ZEAMIWOOPERACONFDETType
 *
 ...
 */
class ZEAMIWOOPERACONFDETTypeViewModel(application: Application): EntityViewModel<ZEAMIWOOPERACONFDETType>(application, EntitySets.zeamIWoOperaConfDet, ZEAMIWOOPERACONFDETType.finalConfirmation) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ZEAMIWOOPERACONFDETType>(application, EntitySets.zeamIWoOperaConfDet, ZEAMIWOOPERACONFDETType.finalConfirmation, navigationPropertyName, entityData)
    }
}
