package com.akso.realwear.app.viewmodel.wotilecounter
...
/*
 * Represents View model for WOTileCounter
 *
 ...
 */
class WOTileCounterViewModel(application: Application): EntityViewModel<WOTileCounter>(application, EntitySets.woTileCounterSet, WOTileCounter.maintenanceOrderInternalID) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<WOTileCounter>(application, EntitySets.woTileCounterSet, WOTileCounter.maintenanceOrderInternalID, navigationPropertyName, entityData)
    }
}
