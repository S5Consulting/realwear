package com.akso.realwear.app.viewmodel.zeamcworkorderlistparameters
...
/*
 * Represents View model for ZEAMCWORKORDERLISTParameters
 *
 ...
 */
class ZEAMCWORKORDERLISTParametersViewModel(application: Application): EntityViewModel<ZEAMCWORKORDERLISTParameters>(application, EntitySets.workOrderListSet, ZEAMCWORKORDERLISTParameters.phase1) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ZEAMCWORKORDERLISTParameters>(application, EntitySets.workOrderListSet, ZEAMCWORKORDERLISTParameters.phase1, navigationPropertyName, entityData)
    }
}
