package com.akso.realwear.app.viewmodel.equipmentlist
...
/*
 * Represents View model for EquipmentList
 *
 ...
 */
class EquipmentListViewModel(application: Application): EntityViewModel<EquipmentList>(application, EntitySets.equipmentListSet, EquipmentList.equipment) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<EquipmentList>(application, EntitySets.equipmentListSet, EquipmentList.equipment, navigationPropertyName, entityData)
    }
}
