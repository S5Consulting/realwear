package com.akso.realwear.app.viewmodel.zeamiwoobjectlisttype
...
/*
 * Represents View model for ZEAMIWOOBJECTLISTType
 *
 ...
 */
class ZEAMIWOOBJECTLISTTypeViewModel(application: Application): EntityViewModel<ZEAMIWOOBJECTLISTType>(application, EntitySets.zeamIWoObjectList, ZEAMIWOOBJECTLISTType.equipmentDesc) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ZEAMIWOOBJECTLISTType>(application, EntitySets.zeamIWoObjectList, ZEAMIWOOBJECTLISTType.equipmentDesc, navigationPropertyName, entityData)
    }
}
