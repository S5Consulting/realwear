package com.akso.realwear.app.viewmodel.checkappsaccess
...
/*
 * Represents View model for CheckAppsAccess
 *
 ...
 */
class CheckAppsAccessViewModel(application: Application): EntityViewModel<CheckAppsAccess>(application, EntitySets.checkAppsAccessSet, CheckAppsAccess.factsheet) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<CheckAppsAccess>(application, EntitySets.checkAppsAccessSet, CheckAppsAccess.factsheet, navigationPropertyName, entityData)
    }
}
