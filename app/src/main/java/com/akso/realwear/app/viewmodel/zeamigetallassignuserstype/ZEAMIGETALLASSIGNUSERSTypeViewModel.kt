package com.akso.realwear.app.viewmodel.zeamigetallassignuserstype
...
/*
 * Represents View model for ZEAMIGETALLASSIGNUSERSType
 *
 ...
 */
class ZEAMIGETALLASSIGNUSERSTypeViewModel(application: Application): EntityViewModel<ZEAMIGETALLASSIGNUSERSType>(application, EntitySets.zeamIGetAllAssignUsers, ZEAMIGETALLASSIGNUSERSType.personnelNumber) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ZEAMIGETALLASSIGNUSERSType>(application, EntitySets.zeamIGetAllAssignUsers, ZEAMIGETALLASSIGNUSERSType.personnelNumber, navigationPropertyName, entityData)
    }
}
