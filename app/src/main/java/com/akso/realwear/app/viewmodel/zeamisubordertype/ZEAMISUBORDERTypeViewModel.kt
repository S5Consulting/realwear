package com.akso.realwear.app.viewmodel.zeamisubordertype
...
/*
 * Represents View model for ZEAMISUBORDERType
 *
 ...
 */
class ZEAMISUBORDERTypeViewModel(application: Application): EntityViewModel<ZEAMISUBORDERType>(application, EntitySets.zeamISubOrder, ZEAMISUBORDERType.orderDescription) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ZEAMISUBORDERType>(application, EntitySets.zeamISubOrder, ZEAMISUBORDERType.orderDescription, navigationPropertyName, entityData)
    }
}
