...
import com.akso.realwear.app.archcomp.SingleLiveEvent
import com.akso.realwear.app.repository.OperationResult.Operation
 ...
 * @param zFIORI_EAM_APP_SRV_Entities OData service
...
class Repository<T : EntityValue>(
        private val zFIORI_EAM_APP_SRV_Entities: ZFIORI_EAM_APP_SRV_Entities,
    ...
    fun read() {
        ...
        zFIORI_EAM_APP_SRV_Entities.executeQueryAsync(dataQuery,
            { result ->
    ...
    fun read(parent: EntityValue, navigationPropertyName: String) {
        ...
        zFIORI_EAM_APP_SRV_Entities.loadPropertyAsync(navigationProperty, parent, dataQuery,
            {
    ...
    fun create(newEntity: T, media: StreamBase) {
        if (newEntity.entityType.isMedia) {
            zFIORI_EAM_APP_SRV_Entities.createMediaAsync(newEntity, media,
                {
    ...
    fun create(newEntity: T) {
        ...
        zFIORI_EAM_APP_SRV_Entities.createEntityAsync(newEntity,
            {
                insertToCache(newEntity, entities)
                if (relatedEntities.size > 0) {
                    insertToCache(newEntity, relatedEntities)
    ...
    fun update(updateEntity: T) {
        zFIORI_EAM_APP_SRV_Entities.updateEntityAsync(updateEntity,
            {
    ...
    fun delete(deleteEntities: MutableList<T>) {
        ...
        zFIORI_EAM_APP_SRV_Entities.applyChangesAsync(deleteChangeSet,
            {
    ...
    fun downloadMedia(entity:T, successHandler:Action1<ByteArray>,
        failureHandler:Action1<RuntimeException>) {
            zFIORI_EAM_APP_SRV_Entities.downloadMediaAsync(entity,
