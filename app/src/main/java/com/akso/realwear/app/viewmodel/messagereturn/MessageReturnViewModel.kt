package com.akso.realwear.app.viewmodel.messagereturn
...
/*
 * Represents View model for MessageReturn
 *
 ...
 */
class MessageReturnViewModel(application: Application): EntityViewModel<MessageReturn>(application, EntitySets.messageReturnSet, MessageReturn.type_) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<MessageReturn>(application, EntitySets.messageReturnSet, MessageReturn.type_, navigationPropertyName, entityData)
    }
}
