package com.akso.realwear.app.viewmodel.workorderlist
...
/*
 * Represents View model for WorkOrderList
 *
 ...
 */
class WorkOrderListViewModel(application: Application): EntityViewModel<WorkOrderList>(application, EntitySets.zeamCWORKORDERLISTSet, WorkOrderList.maintOrderWithLeadingZeros) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<WorkOrderList>(application, EntitySets.zeamCWORKORDERLISTSet, WorkOrderList.maintOrderWithLeadingZeros, navigationPropertyName, entityData)
    }
}
