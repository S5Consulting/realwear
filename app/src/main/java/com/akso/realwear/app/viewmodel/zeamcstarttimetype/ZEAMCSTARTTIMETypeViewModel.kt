package com.akso.realwear.app.viewmodel.zeamcstarttimetype
...
/*
 * Represents View model for ZEAMCSTARTTIMEType
 *
 ...
 */
class ZEAMCSTARTTIMETypeViewModel(application: Application): EntityViewModel<ZEAMCSTARTTIMEType>(application, EntitySets.zeamCStartTime, ZEAMCSTARTTIMEType.startDate) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ZEAMCSTARTTIMEType>(application, EntitySets.zeamCStartTime, ZEAMCSTARTTIMEType.startDate, navigationPropertyName, entityData)
    }
}
