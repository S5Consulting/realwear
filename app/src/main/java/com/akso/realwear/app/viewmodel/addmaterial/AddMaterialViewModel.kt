package com.akso.realwear.app.viewmodel.addmaterial
...
/*
 * Represents View model for AddMaterial
 *
 ...
 */
class AddMaterialViewModel(application: Application): EntityViewModel<AddMaterial>(application, EntitySets.zeamCADDMATERIALSet, AddMaterial.plant) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<AddMaterial>(application, EntitySets.zeamCADDMATERIALSet, AddMaterial.plant, navigationPropertyName, entityData)
    }
}
