package com.akso.realwear.app.viewmodel.usercontact
...
/*
 * Represents View model for UserContact
 *
 ...
 */
class UserContactViewModel(application: Application): EntityViewModel<UserContact>(application, EntitySets.userContactSet, UserContact.person) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<UserContact>(application, EntitySets.userContactSet, UserContact.person, navigationPropertyName, entityData)
    }
}
