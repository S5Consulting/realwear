package com.akso.realwear.app.viewmodel.zeamcwooperdocumentsparameters
...
/*
 * Represents View model for ZEAMCWOOPERDOCUMENTSParameters
 *
 ...
 */
class ZEAMCWOOPERDOCUMENTSParametersViewModel(application: Application): EntityViewModel<ZEAMCWOOPERDOCUMENTSParameters>(application, EntitySets.workOrdSubOperDocSet, ZEAMCWOOPERDOCUMENTSParameters.maintOrderRoutingNumber) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ZEAMCWOOPERDOCUMENTSParameters>(application, EntitySets.workOrdSubOperDocSet, ZEAMCWOOPERDOCUMENTSParameters.maintOrderRoutingNumber, navigationPropertyName, entityData)
    }
}
