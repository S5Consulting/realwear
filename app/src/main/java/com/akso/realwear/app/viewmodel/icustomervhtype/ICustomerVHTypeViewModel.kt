package com.akso.realwear.app.viewmodel.icustomervhtype
...
/*
 * Represents View model for ICustomerVHType
 *
 ...
 */
class ICustomerVHTypeViewModel(application: Application): EntityViewModel<ICustomerVHType>(application, EntitySets.iCustomerVH, ICustomerVHType.organizationBPName1) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ICustomerVHType>(application, EntitySets.iCustomerVH, ICustomerVHType.organizationBPName1, navigationPropertyName, entityData)
    }
}
