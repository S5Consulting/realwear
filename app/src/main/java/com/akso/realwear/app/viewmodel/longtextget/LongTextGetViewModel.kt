package com.akso.realwear.app.viewmodel.longtextget
...
/*
 * Represents View model for LongTextGet
 *
 ...
 */
class LongTextGetViewModel(application: Application): EntityViewModel<LongTextGet>(application, EntitySets.longTextGetSet, LongTextGet.objectType) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<LongTextGet>(application, EntitySets.longTextGetSet, LongTextGet.objectType, navigationPropertyName, entityData)
    }
}
