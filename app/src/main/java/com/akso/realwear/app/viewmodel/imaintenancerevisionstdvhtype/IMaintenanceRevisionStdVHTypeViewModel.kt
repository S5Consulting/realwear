package com.akso.realwear.app.viewmodel.imaintenancerevisionstdvhtype
...
/*
 * Represents View model for IMaintenanceRevisionStdVHType
 *
 ...
 */
class IMaintenanceRevisionStdVHTypeViewModel(application: Application): EntityViewModel<IMaintenanceRevisionStdVHType>(application, EntitySets.iMaintenanceRevisionStdVH, IMaintenanceRevisionStdVHType.maintenanceRevisionDesc) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<IMaintenanceRevisionStdVHType>(application, EntitySets.iMaintenanceRevisionStdVH, IMaintenanceRevisionStdVHType.maintenanceRevisionDesc, navigationPropertyName, entityData)
    }
}
