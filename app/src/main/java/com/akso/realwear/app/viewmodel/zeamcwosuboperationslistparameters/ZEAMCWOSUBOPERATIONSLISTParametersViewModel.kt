package com.akso.realwear.app.viewmodel.zeamcwosuboperationslistparameters
...
/*
 * Represents View model for ZEAMCWOSUBOPERATIONSLISTParameters
 *
 ...
 */
class ZEAMCWOSUBOPERATIONSLISTParametersViewModel(application: Application): EntityViewModel<ZEAMCWOSUBOPERATIONSLISTParameters>(application, EntitySets.woSubOperaListSet, ZEAMCWOSUBOPERATIONSLISTParameters.orderNumber) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ZEAMCWOSUBOPERATIONSLISTParameters>(application, EntitySets.woSubOperaListSet, ZEAMCWOSUBOPERATIONSLISTParameters.orderNumber, navigationPropertyName, entityData)
    }
}
