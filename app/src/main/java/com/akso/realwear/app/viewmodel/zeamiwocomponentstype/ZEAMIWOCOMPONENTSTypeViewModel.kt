package com.akso.realwear.app.viewmodel.zeamiwocomponentstype
...
/*
 * Represents View model for ZEAMIWOCOMPONENTSType
 *
 ...
 */
class ZEAMIWOCOMPONENTSTypeViewModel(application: Application): EntityViewModel<ZEAMIWOCOMPONENTSType>(application, EntitySets.zeamIWoComponents, ZEAMIWOCOMPONENTSType.material) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ZEAMIWOCOMPONENTSType>(application, EntitySets.zeamIWoComponents, ZEAMIWOCOMPONENTSType.material, navigationPropertyName, entityData)
    }
}
