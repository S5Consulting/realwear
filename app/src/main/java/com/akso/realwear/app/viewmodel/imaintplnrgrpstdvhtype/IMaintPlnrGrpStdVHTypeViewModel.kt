package com.akso.realwear.app.viewmodel.imaintplnrgrpstdvhtype
...
/*
 * Represents View model for IMaintPlnrGrpStdVHType
 *
 ...
 */
class IMaintPlnrGrpStdVHTypeViewModel(application: Application): EntityViewModel<IMaintPlnrGrpStdVHType>(application, EntitySets.iMaintPlnrGrpStdVH, IMaintPlnrGrpStdVHType.maintenancePlannerGroupName) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<IMaintPlnrGrpStdVHType>(application, EntitySets.iMaintPlnrGrpStdVH, IMaintPlnrGrpStdVHType.maintenancePlannerGroupName, navigationPropertyName, entityData)
    }
}
