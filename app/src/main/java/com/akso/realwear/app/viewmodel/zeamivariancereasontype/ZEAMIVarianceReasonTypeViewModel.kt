package com.akso.realwear.app.viewmodel.zeamivariancereasontype
...
/*
 * Represents View model for ZEAMIVarianceReasonType
 *
 ...
 */
class ZEAMIVarianceReasonTypeViewModel(application: Application): EntityViewModel<ZEAMIVarianceReasonType>(application, EntitySets.zeamIVarianceReason, ZEAMIVarianceReasonType.varianceReasonCodeText) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ZEAMIVarianceReasonType>(application, EntitySets.zeamIVarianceReason, ZEAMIVarianceReasonType.varianceReasonCodeText, navigationPropertyName, entityData)
    }
}
