package com.akso.realwear.app.viewmodel.zeamcaddmaterialparameters
...
/*
 * Represents View model for ZEAMCADDMATERIALParameters
 *
 ...
 */
class ZEAMCADDMATERIALParametersViewModel(application: Application): EntityViewModel<ZEAMCADDMATERIALParameters>(application, EntitySets.addMaterialSet, ZEAMCADDMATERIALParameters.planningPlant) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ZEAMCADDMATERIALParameters>(application, EntitySets.addMaterialSet, ZEAMCADDMATERIALParameters.planningPlant, navigationPropertyName, entityData)
    }
}
