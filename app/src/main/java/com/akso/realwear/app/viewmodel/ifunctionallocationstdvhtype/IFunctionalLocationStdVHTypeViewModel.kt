package com.akso.realwear.app.viewmodel.ifunctionallocationstdvhtype
...
/*
 * Represents View model for IFunctionalLocationStdVHType
 *
 ...
 */
class IFunctionalLocationStdVHTypeViewModel(application: Application): EntityViewModel<IFunctionalLocationStdVHType>(application, EntitySets.iFunctionalLocationStdVH, IFunctionalLocationStdVHType.functionalLocationText) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<IFunctionalLocationStdVHType>(application, EntitySets.iFunctionalLocationStdVH, IFunctionalLocationStdVHType.functionalLocationText, navigationPropertyName, entityData)
    }
}
