package com.akso.realwear.app.viewmodel.isalesorderstdvhtype
...
/*
 * Represents View model for ISalesOrderStdVHType
 *
 ...
 */
class ISalesOrderStdVHTypeViewModel(application: Application): EntityViewModel<ISalesOrderStdVHType>(application, EntitySets.iSalesOrderStdVH, ISalesOrderStdVHType.salesOrder) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ISalesOrderStdVHType>(application, EntitySets.iSalesOrderStdVH, ISalesOrderStdVHType.salesOrder, navigationPropertyName, entityData)
    }
}
