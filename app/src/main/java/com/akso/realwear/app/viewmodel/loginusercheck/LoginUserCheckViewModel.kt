package com.akso.realwear.app.viewmodel.loginusercheck
...
/*
 * Represents View model for LoginUserCheck
 *
 ...
 */
class LoginUserCheckViewModel(application: Application): EntityViewModel<LoginUserCheck>(application, EntitySets.loginUserCheckSet, LoginUserCheck.isForeman) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<LoginUserCheck>(application, EntitySets.loginUserCheckSet, LoginUserCheck.isForeman, navigationPropertyName, entityData)
    }
}
